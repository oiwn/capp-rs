...
- [ ] rename example/basic.rs into executor_basic.rs
- [-] make_sorage return TaskStorage instead of wrapped with Arc<>
- [-] task fail into storage, to collect totaly (max_retries) failed tasks
...
- [-] use same builder pattern for Application
